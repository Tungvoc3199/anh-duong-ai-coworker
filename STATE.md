...
- Source/dev default API bind: `127.0.0.1:8790`.
...
- Active Core release path: `/home/thadc/AIOS/releases/anh-duong-core/ad-semantic-execution-tool-policy-1-29487e2`.
- Production Core bind: `127.0.0.1:8792`.
- OpenClaw Core URL: `http://host.docker.internal:8792`.
